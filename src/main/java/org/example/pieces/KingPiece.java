...
public class KingPiece implements Piece, Serializable {
    ...
    public void move(Square currentSquare, Square squareToMoveTo, Square[][] squares) {
        if (canMove) {
            this.allegiance.moveKing(currentSquare, squareToMoveTo, squares);
        }
    }
    ...
    public void attack(Square currentSquare, Square squareToAttack, Square[][] squares) {
        if (canAttack) {
            this.allegiance.attackWithKing(currentSquare, squareToAttack, squares);
        }
    }
